...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-center  header-transparent ">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <div class="logo">
        <!-- <h1><a href="index.php">WAGE BIRO - Technic</a></h1> -->
        <a href="index.php"><img src="assets/img/Logo WAGE Remake-02-White.png" alt="" class="img-fluid"></a>
      </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 mt-5 mt-lg-0 ">
            <div class="icon-box" data-aos="zoom-in-left" data-aos-delay="200">
              <div class="icon"><i class="bi bi-window-stack" style="color: #3fcdc7;"></i></div>
          ...
          <div class="col-lg-4 col-md-6 mt-5">
            <div class="icon-box" data-aos="zoom-in-left" data-aos-delay="300">
              <div class="icon"><i class="bi bi-lightning-charge" style="color:#41cf2e;"></i></div>
  ...
  <footer id="footer">
    <div class="container">
      <h3>Wage Biro Technic</h3>
      <p>TECH SOLUTIONS YOUR WAY</p>
      ...
      <div class="copyright">
        &copy; Copyright <strong><span>Wage Biro Technic</span></strong>. All Rights Reserved
      </div>
      <div class="credits">
        Designed by <a href="#">Heart</a>
      </div>
    </div>
  </footer>
  <!-- End Footer -->
